...
def get_user_input(feature_names_list_from_training):
    ...
    if 'Positive_Symptom_Score' in feature_names_list_from_training:
        inputs['Positive_Symptom_Score'] = st.sidebar.slider("Skor Gejala Positif", min_value=0, max_value=50, value=10, step=1, help="Contoh: PANSS Positive Subscale")
    
    if 'Negative_Symptom_Score' in feature_names_list_from_training:
        inputs['Negative_Symptom_Score'] = st.sidebar.slider("Skor Gejala Negatif", min_value=0, max_value=50, value=10, step=1, help="Contoh: PANSS Negative Subscale")
